class RightScorecard {
    ...
    updatePersistentScore() {
        var score = {
            score: this.score,
            happyPassengers: this.happyPassengers,
            sadPassengers: this.sadPassengers
        };
        setScore(score);
    }
    ...
    show() {
        ...
        <div class="my-1">
            <div class="row animate__animated my-1" id="score">
                <div class="col-8">Driver Name:</div>
                <div class="col-4 text-right">${titleCase(driverName)}</div>
            </div>
            <div class="row animate__animated my-1" id="score">
                <div class="col-8">Time Remaining:</div>
                <div class="col-4 text-right">${finalTime}</div>
            </div>
            <div class="row animate__animated my-1" id="score">
                <div class="col-8">Score:</div>
                <div class="col-4 text-right">${this.score}</div>
            </div>
            <div class="row animate__animated my-1" id="happy-passengers">
                <div class="col-8">Visited Places:</div>
                <div class="col-4 text-right">${this.happyPassengers}</div>
            </div>
            <div class="row animate__animated my-1" id="sad-passengers">
                <div class="col-8">Missed Places:</div>
                <div class="col-4 text-right">${this.sadPassengers}</div>
            </div>
        </div>
        `;
        $('#rightDiv').html(html);
